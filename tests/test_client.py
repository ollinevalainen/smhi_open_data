...
class TestClient(unittest.TestCase):
    ...
    def test_observations(self):
        observations = self.client.get_latest_observations(
    ...
    def test_get_parameter(self):
        ...
        self.assertEqual(
            parameter, Parameter.TemperaturePast1h, "Wrong parameter returned."
        )

    def test_get_parameter_stations(self):
        stations = self.client.get_parameter_stations(
            parameter=Parameter.TemperaturePast1h
        )
    ...
    def test_get_station_parameters(self):
        ...
        self.assertIsInstance(
            parameters[0], Parameter, "Returned parameters were not parameter nums."
        )
